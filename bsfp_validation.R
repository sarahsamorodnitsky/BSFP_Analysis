...
response_continuous_missing0.7 <- validation_simulation(nsample = 10000, n_clust = 5, p.vec, n, true_params, model_params, nsim = 100, center = FALSE, nninit = FALSE, ranks = ranks, response = "continuous", missingness = "missingness_in_response", missing_data_type = NULL, prop_missing = 0.7)
